...
export default function Header() {
    ...
    return (
        <div className="absolute z-10 top-0 flex w-full pl-4 sm:pl-6 pr-24 h-20 sm:h-18 pt-6 sm:pt-10 justify-between items-start sm:items-end font-sans text-white flex-col sm:flex-row gap-1 sm:gap-4">   
            { userId ? (
                <>
                    ...
                    <div className="absolute top-6 right-6 sm:top-9">
